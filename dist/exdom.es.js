...
export { addClassName, ancestors, append, clearClassName, getClassName, hasClassName, hide, html, insertAfter, insertBefore, insertNode, next, prepend, previous, query, queryAll, recursivelyCollect, removeChild, removeClassName, removeNode, show, siblings, text, toggleClassName };
